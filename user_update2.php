            ...
            <div class="py-3 px-5 col-4 offset-4">
                ...
                <form action="/user_update3.php" method="post" onsubmit="return chkForm();">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="pwd-comment" class="m-2">비밀번호를 변경하고 싶다면 입력하세요.</div>    
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="user-name" name="user_name" placeholder="이름" value="<?=$user_name?>" onchange="checkUserName();" onkeyup="checkUserName();">
                        <div id="user-name-comment" class="m-2">이름 입력 체크</div>    
                    </div>

                    <div class="mb-3">
                        <label for="hp" class="form-label">Phone Number</label>
                        <input type="text" class="form-control" id="hp" name="hp" placeholder="휴대전화번호" value="<?=$hp?>" onchange="checkHp();" onkeyup="checkHp();">
